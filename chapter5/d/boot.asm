;完成的主要工作就是在根目录区寻找loader.bin文件，并且加载loader.bin文件到物理地址90100h处
...
;================================================================================================
	...
	nop				; 这个 nop 不可少,在loader.asm中没有，因为这里我们需要做512字节的引导
...
; *****************************************************************************************************
	jmp	BaseOfLoader:OffsetOfLoader	; 这一句正式跳转到已加载到内存中的 LOADER.BIN 的开始处
						; 开始执行 LOADER.BIN 的代码,并且cs寄存器的值为baseofloader=9000h
						; Boot Sector 的使命到此结束
; *****************************************************************************************************
